'''LeNet in PyTorch.'''
__all__ = ['LeNet_Decomp']
import torch
import torch.nn as nn
import torch.nn.functional as F
from AligeNet.layers.FCDecomp import FCDecomp
from AligeNet.layers.ConvDecomp2d import ConvDecomp2d
from AligeNet.layers import create_dic_fuc

class LeNet_Dec(nn.Module):
    def __init__(self, num_classes=10, path_pretrained_model='/gaoyangcheng/dicts-vs-kmeans/model_path/lenet-100-best.pth'):
        self.path_pretrained_model = path_pretrained_model
        super(LeNet_Dec, self).__init__()
        try:
        ...
        self.fc3 = FCDecomp(coefs=self.X_a_fc3, dictionary=self.D_fc3, bias_val=self.B_fc3, input_features=84, output_features=num_classes)
...
def LeNet_Decomp(pretrained=False, num_classes=10, path_pretrained_model='/gaoyangcheng/dicts-vs-kmeans/model_path/lenet-100-best.pth'):
    return LeNet_Dec()